...
from src.stonix_resources.rules.DisableGuestAccess import DisableGuestAccess


class zzzTestRuleDisableGuestAccess(RuleTest):
    ...
    def setConditionsForRule(self):
        ...
        commands:
        defaults -currentHost write /Library/Preferences/com.apple.AppleFileServer guestAccess -bool no
        defaults -currentHost write /Library/Preferences/SystemConfiguration/com.apple.smb.server AllowGuestAccess -bool no
