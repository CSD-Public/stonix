...
class zzzTestRuleConfigureProcessAccounting(RuleTest):
    ...
    def setUp(self):
        ...
        if self.sh.auditservice(package):
    ...
    def tearDown(self):
        ...
        if self.svcEnabled and not self.sh.auditservice(package):
            self.sh.enableservice(package)
        elif not self.svcEnabled and self.sh.auditservice(package):
    ...
    def testServiceHelperFunctions(self):
        ...
        if self.svcEnabled:
            self.sh.disableservice(package)
            self.assertFalse(self.sh.auditservice(package),
                             "ServiceHelper.auditservice is not False " +
                             "after ServiceHelper.disableservice")
            self.sh.enableservice(package)
            self.assertTrue(self.sh.auditservice(package),
