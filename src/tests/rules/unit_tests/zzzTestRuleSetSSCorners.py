...
###############################################################################
'''
This is a Unit Test for Rule SetSSCorners
...
from src.stonix_resources.rules.SetSSCorners import SetSSCorners
...
class zzzTestRuleSetSSCorners(RuleTest):
    ...
    def setConditionsForRule(self):
        ...
        cmd = '/usr/bin/defaults write ' + '\"' + self.environ.geteuidhome() + '/Library/Preferences/com.apple.dock.plist\" '
        for item in optdict:
