...
'''
This is a unit test for rule STIGConfigureBluetoothPolicy
...
from src.stonix_resources.rules.STIGConfigureBluetoothPolicy import STIGConfigureBluetoothPolicy
from re import search

class zzzTestRuleSTIGConfigureBluetoothPolicy(RuleTest):
    ...
    def setConditionsForRule(self):
        ...
        if not self.ch.executeCommand(cmd):
            ...
            if output:
                for line in output:
                    if search("Bluetooth\ Policy$", line.strip()):
