...
from stonix_resources.rules.DisableNobodyAccess import DisableNobodyAccess
from stonix_resources.stonixutilityfunctions import readFile, writeFile, checkPerms

class zzzTestRuleDisableNobodyAccess(RuleTest):

    def setUp(self):
        RuleTest.setUp(self)
        self.rule = DisableNobodyAccess(self.config,
                                        self.environ,
                                        self.logdispatch,
                                        self.statechglogger)
