...
class GUI (View, QtWidgets.QMainWindow, main_window.Ui_MainWindow):
    ...
    def __init__(self, controller, environment, logger):
        ...
        # set up search box
        self.searchbox = QtWidgets.QLineEdit(parent=QtWidgets.QMainWindow)
...
class runThread(QtCore.QThread):
    ...
    #####
    # New for PyQt5
    supdate_signal = QtCore.pyqtSignal('QString', name="supdate")
    tupdate_signal = QtCore.pyqtSignal('QString', name="tupdate")
    #####
