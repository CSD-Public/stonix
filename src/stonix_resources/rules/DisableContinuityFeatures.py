...
class DisableContinuityFeatures(Rule):
    def __init__(self, config, environ, logdispatch, statechglogger):
        ...
        self.rulenumber = 310
        self.rulename = "DisableContinuityFeatures"
        ...
        self.sethelptext()
        datatype = "bool"
        key = "DISABLECONTINUITY"
        instructions = "To disable this rule set the value of " + \
                       "DISABLECONTINUITY to False"
        default = True
    ...
    def setvars(self):
        ...
        self.siriprofile = baseconfigpath + "stonix4macDisableContinuity.mobileconfig"
        '''Directory location for testing only'''
        # basetestpath = "/Users/username/stonix/src/" + \
        #               "stonix_resources/files/"
        # self.siriprofile = basetestpath + "stonix4macDisableContinuity.mobileconfig"
